...
class SDL_Pi_HDC1000:
        def __init__(self, twi=1, addr=HDC1000_ADDRESS):
                ...
                self._addr = addr
                # 0x10(48)    Temperature, Humidity enabled, Resolultion =
                # 14-bits, Heater off
                config = HDC1000_CONFIG_ACQUISITION_MODE
                self._bus.write_byte_data(
    HDC1000_ADDRESS,
    HDC1000_CONFIGURATION_REGISTER,
     config >> 8)
    ...
    HDC1000_ADDRESS, HDC1000_TEMPERATURE_REGISTER)
                time.sleep(0.020)
        ...
        def readHumidity(self):
                ...
                self._bus.write_byte(
    HDC1000_ADDRESS, HDC1000_HUMIDITY_REGISTER)
        ...
        def readConfigRegister(self):
                ...
                self._bus.write_byte(
    HDC1000_ADDRESS, HDC1000_CONFIGURATION_REGISTER)
