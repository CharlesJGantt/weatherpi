...
def PowerVoltageGraph(source, days, delay):
    ...
    try:
        ...
        pylab.figtext(.5, .05, ("GroveWeatherPi Power Voltage Last %i Days" %
        ...
        try:
            pyplot.savefig(
                "/home/pi/RasPiConnectServer/static/PowerVoltageGraph.png", facecolor=fig.get_facecolor())
        except:
            pyplot.savefig(
                "/home/pi/SDL_Pi_GroveWeatherPi/static/PowerVoltageGraph.png", facecolor=fig.get_facecolor())
