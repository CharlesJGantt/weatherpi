...
def BarometerLightningGraph(source, days, delay):
    ...
    try:
        ...
        pylab.plot(t, s, color='b', label="Barometric Pressure (mb) ",
                   linestyle="-", marker=".")
        pylab.xlabel("Hours")
        ...
        pylab.plot(t, u, color='y', label="as3935 Last Interrupt",
                   linestyle="-", marker=".")
        pylab.plot(t, v, color='r', label="as3935 Last Distance",
                   linestyle="-", marker=".")
        pylab.axis([min(t), max(t), 0, max(u)])
        pylab.legend(loc='lower left')
        pylab.figtext(.5, .05, ("Barometer and Lightning Statistics Last %i Days" %
        ...
        try:
            ...
            pyplot.savefig(
                "/home/pi/SDL_Pi_GroveWeatherPi/static/BarometerLightningGraph.png")
