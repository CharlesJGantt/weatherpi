...
def BarometerLightningGraph(source, days, delay):
    print(f"BarometerLightningGraph source: {source} days: {days}")
    ...
    try:
        ...
        query = (
            "SELECT TimeStamp, bmp180SeaLevel, as3935LastInterrupt, as3935LastDistance "
            "FROM WeatherData "
        ...
        pylab.figtext(.5, .05, f"Barometer and Lightning Statistics Last {days} Days", fontsize=18, ha='center')
